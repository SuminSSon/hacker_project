...
public class BoardDto {
    ...
    private LocalDateTime board_date = LocalDateTime.parse(LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy.MM.dd HH:mm")));;  // 게시글 작성일자
    ...
    // Entity -> Dto
    @Builder
    public BoardDto(User user, BoardType type, String title, String content) {
